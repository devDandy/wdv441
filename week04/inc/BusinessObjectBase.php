...
//     $first_name_error = $_POST['inFirstNameError'];
//     $last_name_error = $_POST['inLastNameError'];
//     $email_address_error = $_POST['inEmailError'];
//     $date_of_birth_error = $_POST['inDateOfBirthError'];
//     $in_message_error = $_POST['inMessageError'];
